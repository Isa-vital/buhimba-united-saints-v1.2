    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0 text-gray-800">Edit Merchandise</h1>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit: {{ $merchandise->name }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.merchandise.update', $merchandise) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           id="name" name="name" value="{{ old('name', $merchandise->name) }}" required>
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                        ...
                                        @foreach(\App\Models\Merchandise::TYPES as $key => $value)
                                            <option value="{{ $key }}" {{ old('type', $merchandise->type) == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                           id="price" name="price" value="{{ old('price', $merchandise->price) }}" min="0" step="0.01" required>
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('stock_quantity') is-invalid @enderror" 
                                           id="stock_quantity" name="stock_quantity" value="{{ old('stock_quantity', $merchandise->stock_quantity) }}" min="0" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3">{{ old('description', $merchandise->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3" id="size-options">
                            ...
                            <div class="row">
                                @php $sizeOptions = old('size_options', $merchandise->size_options ?? []); @endphp
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="size_options[]" value="XS" id="size_xs"
                                               {{ in_array('XS', $sizeOptions) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="size_options[]" value="S" id="size_s"
                                               {{ in_array('S', $sizeOptions) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="size_options[]" value="M" id="size_m"
                                               {{ in_array('M', $sizeOptions) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="size_options[]" value="L" id="size_l"
                                               {{ in_array('L', $sizeOptions) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="size_options[]" value="XL" id="size_xl"
                                               {{ in_array('XL', $sizeOptions) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="size_options[]" value="XXL" id="size_xxl"
                                               {{ in_array('XXL', $sizeOptions) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Update Merchandise
                            </button>
                        </div>
                    </form>
                </div>
